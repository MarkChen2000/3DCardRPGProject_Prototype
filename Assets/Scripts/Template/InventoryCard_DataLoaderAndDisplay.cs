...
public class InventoryCard_DataLoaderAndDisplay : BasicCard_DataLoaderAndDisplay
{
    ...
    protected override void GetComponentofTemplates() 
    {
        ...
        TMP_CardHoldNum = Trans_CardPanel.GetChild(5).GetChild(0).GetComponent<TMP_Text>();

        Trans_WeaponAPPanel = Trans_CardPanel.GetChild(6);
        Trans_WeaponCRPanel = Trans_CardPanel.GetChild(7);
        Trans_ArmorDPPanel = Trans_CardPanel.GetChild(8);
        Trans_ArmorDSPPane = Trans_CardPanel.GetChild(9);

        TMP_WeaponAP = Trans_CardPanel.GetChild(6).GetChild(0).GetComponent<TMP_Text>();
        TMP_WeaponCR = Trans_CardPanel.GetChild(7).GetChild(0).GetComponent<TMP_Text>();
        TMP_ArmorDP = Trans_CardPanel.GetChild(8).GetChild(0).GetComponent<TMP_Text>();
        TMP_ArmorDSP = Trans_CardPanel.GetChild(9).GetChild(0).GetComponent<TMP_Text>();
    }
